...
@Component({
  selector: 'app-dynamic-leftmenu',
  templateUrl: './dynamic-leftmenu.component.html',
  styleUrls: ['./dynamic-leftmenu.component.scss']
})
export class DynamicLeftmenuComponent implements OnInit {
...
openDyanmicForm(){
  ...
  constructor(private router: Router, @Inject(AppComponent) private app: AppComponent, private allserviceService:AllservicesService ) {
 ...
 if(id?.classList.toString()=='nested active'){
  ...
  toggleDisplayDivIf() {
    console.log(this.arrowFiled);
    this.arrowFiled = !this.arrowFiled;
