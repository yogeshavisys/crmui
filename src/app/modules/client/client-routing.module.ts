import { CreateUserComponent } from './hrms/create-user/create-user.component';
...
import { HrDashboardComponent } from './hrms/product-family-table/hr-dashboard.component';
import { HrUsersComponent } from './hrms/product-line-table/hr-users.component';
...
import { ProductFamilyFormComponent } from './hrms/product-family-form/product-family-form.component';
import { ProductLineFormComponent } from './hrms/product-line-form/product-line-form.component';
import { EntitygroupFormComponent } from './hrms/entitygroup-form/entitygroup-form.component';
import { ProducttemplateFormComponent } from './hrms/producttemplate-form/producttemplate-form.component';
import { ProductAttributeComponent } from './hrms/product-attribute/product-attribute.component';
import { ProductTabComponent } from './hrms/product-tab/product-tab.component';
import { DynamicLeftmenuComponent } from './dynamic-leftmenu/dynamic-leftmenu.component';
import { SectionFromTemplateComponent } from './section-from-template/section-from-template.component';
import { TabfromTemplateComponent } from './tabfrom-template/tabfrom-template.component';


const routes: Routes = [
  {path:'sectionfrom',component:SectionFromTemplateComponent},
  {path:'tabSection',component:TabfromTemplateComponent},
  {path:'create-user',component:CreateUserComponent},
  {
    path: 'dynamic-leftmenu',
    component: DynamicLeftmenuComponent,
    data: { title: 'Dynamic Menu' }
  },
  {
    path: 'hr',
